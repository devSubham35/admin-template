  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-neutral-900 hover:bg-neutral-900 hover:text-neutral-50 focus:bg-neutral-900 focus:text-neutral-50 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-neutral-900",
        day_today: "bg-neutral-100 hover:text-blue-500 text-blue-500 dark:bg-neutral-800 dark:text-neutral-50 font-bold",
        day_outside:
