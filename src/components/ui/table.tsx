...
>(({ className, ...props }, ref) => (
  <div className="relative w-full border-[2px] border-white/5 rounded-lg overflow-hidden">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-white/5 transition-colors data-[state=selected]:bg-neutral-100 dark:data-[state=selected]:bg-neutral-800",
      className
    )}
    {...props}
  />
